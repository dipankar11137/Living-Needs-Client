...
const Baburchi = () => {
  const [services, setServices] = useState([]);
      ...
      useEffect(() => {
        fetch('http://localhost:5000/allServices/Baburchi')
          .then(res => res.json())
          .then(data => {
            setServices(data);
      ...
      return (
        <div className="bg-slate-200">
          <div className="mx-28 mb-10">
            {/* <h1 className="py-4 font-bold text-4xl pl-4">Baburchi</h1> */}
            <div className="py-4 flex justify-between items-center">
              <h1 className="font-bold text-4xl pl-4">Baburchi</h1>
              <div className="flex">
                <input
                  type="text"
